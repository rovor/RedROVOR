...
def renameFITS(origFile,newExt=".fit"):
    ...
    if os.path.isfile(origFile) and origFile.endswith(".FIT"):
...
def renameAll(path,newExt=".fit"):
    '''Rename all FITS files with extension .FIT to extension newExt (defaults
